...
//		this.region = user.getAddress().getRegion();
//		this.countryCode = user.getAddress().getCountry();
//		this.address1 = user.getAddress().getAddressline1();
//		this.address2 = user.getAddress().getAddressline2();
//		this.userTypeCD = user.getUsertype().getUsertypecd();
	}
